...
public class NavigationMapboxMap {
  ...
  public boolean incidentsVisible() {
    return mapIncidents.incidentsVisible();
  }

  public void updateTrafficVisiblity(boolean isVisible) {
    mapTraffic.updateTrafficVisibility(isVisible);
  }

  public boolean trafficVisible() {
    return mapTraffic.trafficVisible();
  }
