...
public class NavigationMapboxMap {
   ...
   * the attribute navigationViewDestinationMarker.
   *
   ...
   * <p>
   * This method uses {@link NavigationMapboxMapInstanceState}, stored with the
   * {@link NavigationMapboxMap#MAP_INSTANCE_STATE_KEY}.
   *
   ...
   * <p>
   * You can extract the {@link NavigationMapboxMapInstanceState} in onRestoreInstanceState and then restore the
   * map once it's ready.
   *
  ...
  /**
   * Will enabled or disable the camera tracking the location updates provided
   ...
   * has been called.
   *
   * @param isEnabled tracking is true, not tracking if false
   */
